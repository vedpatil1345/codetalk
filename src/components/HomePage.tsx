...
import { BrainCircuit, CheckCircle, Globe, Zap } from "lucide-react";
  ...
  return (
    <div className="inline-flex items-center">
      <span className="ml-2 font-mono text-orange-400 dark:text-green-500">
        {"{"}
        <ReactTyped
          className="text-green-500 dark:text-cyan-300"
          strings={strings}
          typeSpeed={150}
          backSpeed={100}
          backDelay={1000}
  ...
  const features = [
    {
      ...
      description: "Use AI to automatically analyze and debug your code",
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: "Access Anywhere",
      description:
        "Access your debugging sessions and projects from any device",
    },
    {
      icon: <CheckCircle className="w-6 h-6" />,
      title: "Error Detection",
      description:
        "Quickly detect and highlight errors in your code with AI assistance",
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "Fast Debugging",
      description:
        "Speed up your debugging process with automated AI suggestions",
    },
  ];
          ...
          <nav className="border-b bg-white dark:bg-gray-800 rounded-xl flex">
            <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between h-16 items-center flex-wrap">
                <div
                  className="flex-shrink-0 flex cursor-pointer"
                  onClick={() => navigate("/")}
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center">
              ...
              <Button
                  ...
                  size="lg"
                  onClick={user ? () => navigate("/code") : handleLoginClick}
                >
                  {user ? "Get Started - It's Free" : "Get Started - It's Free"}
                </Button>
              </div>
            </div>
          </div>
